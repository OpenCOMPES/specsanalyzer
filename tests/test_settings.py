...
default_config_keys = [
    'calib2d_file', 'nx_pixel', 'ny_pixel',
    'pixel_size', 'magnification', 'apply_fft_filter',
]
...
def test_load_config():
    config_json = load_config(Path(f"{package_dir}/../tests/data/config/config.json"))
    config_yaml = load_config(Path(f"{package_dir}/../tests/data/config/config.yaml"))
